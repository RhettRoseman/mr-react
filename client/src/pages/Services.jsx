...
function redirectToOptions() {
  window.location.href = '/options'; // Replace 'options.html' with the URL of your options page
}

document.addEventListener('DOMContentLoaded', function () {
  // Assuming your div has an ID 'myDiv', replace it with your div's IsD
  ...
  return (
    <div className='packages'>
      ...
      <div className="cards">
        ...
        <div className="card" id="c1" onClick={''} >
          <h4 id='bronze'>Bronze</h4>

          <h5>1200.00</h5>
          {/* <h6>Languages</h6>
        <h6> React, HTML:5, CSS, JavaScript</h6>
        <div className="logo">
         {reactLogo} {htmlLogo} {cssLogo} {jsLogo}
          ...
          <ul>
            ...
            <li>Logo</li>
            <li>Up to 5 pages</li>
            <li>Home, About, Contact, Services (Page names Customizable)</li>
            <li> Forms for collection of Data</li>
          </ul>


        </div>

        <div className="card" id="c2" onClick={''} >
          <h4 id='silver'>Silver</h4>
          <h5>2500.00</h5>


          {/* 
        <h6 id='l1'>Languages</h6>
        <h6> React, HTML:5, CSS, JavaScript, TypeScript, Node.js, </h6>
        <div className="logo">
          {reactLogo} {htmlLogo} {cssLogo} {jsLogo} {nodeLogo} {typeScriptLogo}
         
        </div> */}

          <br />
          <ul>
            <li>Everything with Bronze level (without extras) </li>
            <li>Up to 10 pages</li>
            <li>Login for clients/customers</li>
          </ul>

        </div>

        <div className="card" id="c3" onClick={''} >
          <h4 id='gold'> Gold</h4>
          <h5> 4000.00</h5>

          {/* <h6>Languages</h6>
        <h6>React.js, Vite, CSS, SASS, JavaScript, Node.js, Netifly, MongoDB</h6>
        <div className="logo">
         {reactLogo} {viteLogo} {cssLogo} {sassLogo} {jsLogo} {typeScriptLogo} {nodeLogo}
         <div><h6>Databases</h6></div> 
        </div> */}
          <br />
          <ul>
            <li>Everything with Silver and Bronze levels</li>
