...
// html
const htmlLogo = <FontAwesomeIcon icon={faHtml5} style={{ iconStyle, color: 'orangered' }} />
// css
const cssLogo = <FontAwesomeIcon icon={faCss3} style={{ iconStyle, color: "#264de4" }} />
//javascript
const jsLogo = <FontAwesomeIcon icon={faJsSquare} style={{ iconStyle, color: "yellow" }} />
// react
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    myDiv.addEventListener('click', function () {
        redirectToOptions(); // Calling the function to redirect to the options page
    });
});
...
Consider us your comprehensive solution hub for anything related to websites or applications. Our approach is rooted in building from scratch—each system, each component, meticulously developed in-house. However, our expertise doesn't merely stop at inception; we bring a wealth of experience in revitalizing and updating existing live websites. If you're seeking solutions for enhancements or updates to your current digital platform, rest assured, we have the expertise to navigate those waters adeptly.
        ...
        {mongoDbLogo} {sqlLogo} */}
            ...
            <div>
                <h2>Our Team</h2>
                <p>
                    The genesis of ROSE Technologies stemmed from a serendipitous encounter—a class on coding that brought together four dedicated individuals. Through relentless determination, we poured over 14-hour days to conquer the challenges of this class. However, it was more than just a shared educational journey; it became the catalyst for our collective aspiration to venture into entrepreneurship.

                    In the vibrant year of 2023, ROSE Technologies came into being, its very name a fusion of our founding members' initials. Our mission? To empower businesses like yours, ushering them toward success. Specializing in a spectrum of technological solutions—from static and dynamic websites to full-stack applications—we are here to actualize your visions.

                    Our repertoire extends beyond conventional boundaries; Corporate Contracting stands as a testament to our diverse capabilities. We eagerly await the opportunity to collaborate with you and your esteemed companies. Let's weave innovation into the fabric of your success story together.
                </p>
            </div>
